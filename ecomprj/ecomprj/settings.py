...
if USE_SUPABASE_STORAGE:
    ...
    AWS_ACCESS_KEY_ID = env.str("SUPABASE_STORAGE_ACCESS_KEY", default="")
    AWS_SECRET_ACCESS_KEY = env.str("SUPABASE_STORAGE_SECRET_KEY", default="")
    AWS_STORAGE_BUCKET_NAME = env.str("SUPABASE_STORAGE_BUCKET", default="media")
    AWS_S3_ENDPOINT_URL = env.str("SUPABASE_STORAGE_URL", default="")
    AWS_S3_REGION_NAME = env.str("SUPABASE_STORAGE_REGION", default="us-east-1")

    # Supabase public URL for accessing files
    AWS_S3_CUSTOM_DOMAIN = env.str("SUPABASE_STORAGE_PUBLIC_URL", default="")
    ...
    DEFAULT_FILE_STORAGE = "ecomprj.storage_backends.SupabaseMediaStorage"

    # Media URL will be generated by storage backend
    MEDIA_URL = (
        f"https://{AWS_S3_CUSTOM_DOMAIN}/storage/v1/object/public/{AWS_STORAGE_BUCKET_NAME}/media/"
        if AWS_S3_CUSTOM_DOMAIN
        else "/media/"
    )
    MEDIA_ROOT = os.path.join(BASE_DIR, "media")  # Still needed for local operations
else:
