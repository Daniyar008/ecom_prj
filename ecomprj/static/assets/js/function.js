...
$(document).ready(function () {
    ...
    $(".delete-product").on("click", function () {
        ...
        $.ajax({
            url: "/cartorders/delete-from-cart/",
            data: {
                "id": product_id
            },
            dataType: "json",
        ...
        $.ajax({
            ...
            error: function (xhr) {
                if (xhr.status === 401 || xhr.status === 403) {
                    ...
                    console.error("Error adding to wishlist:", xhr.responseJSON?.error || "Unknown error")
                }
            }
        })
    })
    ...
    $(document).on("click", ".delete-wishlist-product", function () {
        ...
        $.ajax({
            url: "/wishlists/remove-from-wishlist/",
            data: {
                "id": wishlist_id
            },
            dataType: "json",
            ...
            error: function (xhr) {
                if (xhr.status === 401 || xhr.status === 403) {
                    ...
                    console.error("Error removing from wishlist:", xhr.responseJSON?.error || "Unknown error")
                }
            }
        })
    })
